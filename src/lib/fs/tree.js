module.exports = function (deps) {
  ...
  var build = function (node, parent) {
     ...
     * object generated by build()
     *
     * but we can make the most of it using it in the node iteration,
     * avoiding the use of underscore dependency so making the code
     * more portable between updated environments
     */
     ...
     * tree
     */
    parent.childnodes = parent.children.map(function (name) {
      return build(node[name], {
        name: name,
